...
### WeDo Technologies
A segunda empresa escolhida foi a [WeDo Technologies](wedotechnologies.com). Procurando por `wedotechnologies.com` no _shodan_, obtém-se o endereço de um dos servidores _ssh_
